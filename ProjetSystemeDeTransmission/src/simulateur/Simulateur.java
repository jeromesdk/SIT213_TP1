...
>>>>>>> refs/remotes/origin/main
	...
	public  Simulateur(String [] args) throws ArgumentsException {
		// analyser et récupérer les arguments   	
		// Ce qui suit n'est qu'un petit exemple de ce qu'on peut faire
		// TODO: : à modifier

		//créer une source aléatoire si demandé
		analyseArguments(args);
		
		if (messageAleatoire == true) {

			SourceAleatoire sourcealea = new SourceAleatoire(nbBitsMess);
